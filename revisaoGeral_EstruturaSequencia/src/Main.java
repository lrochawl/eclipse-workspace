...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.printf("A area do terreno é de %.2f e o valor total do terreno é de R$ %.2f %n %n", tamanho,
				resultValor);
		...
		n1 = sc.nextInt();
		n2 = sc.nextInt();
		System.out.println("Pouco, informe mais dois números");
		n3 = sc.nextInt();
		n4 = sc.nextInt();
		...
		*/
		...
		System.out.println("Número do funcionario, horas trabalhadas, valor da hora");
		func = sc.nextInt();
		H	 = sc.nextDouble();
		V	 = sc.nextDouble();
		TA	 = H * V;
		...
		System.out.println("Codigo da peça, numero da peça, preço (R$)");
		...
		*/
		...
		System.out.printf("TRIÂNGULO: %.3f %nCIRCULO: %.3f %nTRAPEZÍO: %.3f %nQUADRADO: %.3f %nRETÂNGULO: %.3f", aTriangulo, aCirculo, aTrapezio, aQuadrado, aRetangulo);
