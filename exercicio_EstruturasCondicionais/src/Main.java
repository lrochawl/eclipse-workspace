...
public class Main {
	...
	*/
	...
	public static void main(String[] args) {
		...
		System.out.printf("Você comprou %d %s e o valor total é R$%.2f ", quantidade, descricao, total);
	...
	*/
	...
	public static void main(String[] args) {
		...
		if(horas <= 24 && horas > 1) {
			...
			System.out.printf("O JOGO NÃO OBTEVE DURAÇÃO MINIMA DE 1 HORA");
		}else {
	...
	*/
	...
	public static void main(String[] args) {
		...
		System.out.println("Digite dois números inteiros em ordem decrescente");
		N1 = sc.nextInt();
		N2 = sc.nextInt();
