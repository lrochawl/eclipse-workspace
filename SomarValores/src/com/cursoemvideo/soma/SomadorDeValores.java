 ...
 * @author lucas
 */
public class SomadorDeValores extends javax.swing.JFrame {

    /**
     * Creates new form SomadorDeValores
     */
    public SomadorDeValores() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SomadorDeValores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SomadorDeValores().setVisible(true);
            }
        });
    }
